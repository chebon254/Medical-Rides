    ...
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="accordion-group" data-accordion="default-accordion">
          <div
            className={`accordion py-8 px-6 border-b border-solid border-slate-200 transition-all duration-500 rounded-2xl ${openAccordion === 'one' ? 'bg-teal-50' : 'hover:bg-teal-50'
              }`}
            id="basic-heading-one-with-arrow"
          >
            <button
              className={`accordion-toggle group inline-flex items-center justify-between leading-8 text-slate-900 w-full transition duration-500 text-left ${openAccordion === 'one' ? 'font-medium text-teal-600' : 'hover:text-teal-600'
                }`}
            ...
            >
              ...
              <svg
                className={`text-slate-500 transition duration-500 group-hover:text-teal-600 ${openAccordion === 'one' ? 'text-teal-600 rotate-180' : ''
                  }`}
                width="22"
                height="22"
                viewBox="0 0 22 22"
            ...
            {openAccordion === 'one' && (
              ...
              >
                <p className="text-lg text-slate-900 leading-6">
          ...
          <div
            className={`accordion py-8 px-6 border-b border-solid border-slate-200 transition-all duration-500 rounded-2xl ${openAccordion === 'two' ? 'bg-teal-50' : 'hover:bg-teal-50'
              }`}
            id="basic-heading-two-with-arrow"
          >
            <button
              className={`accordion-toggle group inline-flex items-center justify-between leading-8 text-slate-900 w-full transition duration-500 text-left ${openAccordion === 'two' ? 'font-medium text-teal-600' : 'hover:text-teal-600'
                }`}
            ...
            >
              ...
              <svg
                className={`text-slate-500 transition duration-500 group-hover:text-teal-600 ${openAccordion === 'two' ? 'text-teal-600 rotate-180' : ''
                  }`}
                width="22"
                height="22"
                viewBox="0 0 22 22"
          ...
          <div
            className={`accordion py-8 px-6 border-b border-solid border-slate-200 transition-all duration-500 rounded-2xl ${openAccordion === 'three' ? 'bg-teal-50' : 'hover:bg-teal-50'
              }`}
            id="basic-heading-three-with-arrow"
          >
            <button
              className={`accordion-toggle group inline-flex items-center justify-between leading-8 text-slate-900 w-full transition duration-500 text-left ${openAccordion === 'three' ? 'font-medium text-teal-600' : 'hover:text-teal-600'
                }`}
            ...
            >
              ...
              <svg
                className={`text-slate-500 transition duration-500 group-hover:text-teal-600 ${openAccordion === 'three' ? 'text-teal-600 rotate-180' : ''
                  }`}
                width="22"
                height="22"
                viewBox="0 0 22 22"
          ...
          <div
            className={`accordion py-8 px-6 border-b border-solid border-slate-200 transition-all duration-500 rounded-2xl ${openAccordion === 'four' ? 'bg-teal-50' : 'hover:bg-teal-50'
              }`}
            id="basic-heading-four-with-arrow"
          >
            <button
              className={`accordion-toggle group inline-flex items-center justify-between leading-8 text-slate-900 w-full transition duration-500 text-left ${openAccordion === 'four' ? 'font-medium text-teal-600' : 'hover:text-teal-600'
                }`}
            ...
            >
              ...
              <svg
                className={`text-slate-500 transition duration-500 group-hover:text-teal-600 ${openAccordion === 'four' ? 'text-teal-600 rotate-180' : ''
                  }`}
                width="22"
                height="22"
                viewBox="0 0 22 22"
          ...
          <div
            className={`accordion py-8 px-6 border-b border-solid border-slate-200 transition-all duration-500 rounded-2xl ${openAccordion === 'five' ? 'bg-teal-50' : 'hover:bg-teal-50'
              }`}
            id="basic-heading-five-with-arrow"
          >
            <button
              className={`accordion-toggle group inline-flex items-center justify-between leading-8 text-slate-900 w-full transition duration-500 text-left ${openAccordion === 'five' ? 'font-medium text-teal-600' : 'hover:text-teal-600'
                }`}
            ...
            >
              ...
              <svg
                className={`text-slate-500 transition duration-500 group-hover:text-teal-600 ${openAccordion === 'five' ? 'text-teal-600 rotate-180' : ''
                  }`}
                width="22"
                height="22"
                viewBox="0 0 22 22"
