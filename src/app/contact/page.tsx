...
function ContactPage() {
  return (
    <div>
        ...
        <h6 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">
            Reach Out
          </h6>
            <h2 className="mt-1 text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl">Contact Us</h2>
            <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">We would love to hear from you. Please reach out to us with any questions, inquiries, or feedback.</p>
        </div>
        <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
            ...
            <div className="mt-10">
            <button type="submit" className="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Contact Us</button>
            </div>
        </form>
        </div>
    </div>
